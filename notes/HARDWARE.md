...
Of the 58 script blocks in `play.bin` (v0.72.1), only **4 use distributed execute** (opcode 21 / PAwR multi-brick messaging):

| Script | Preset Type | Size | PAwR | Branches | Range Checks | If-Then-Else | Table Lookups |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 0x0B | — | Yes | — | — | — | — |
| 14 | 0x03 | — | Yes | — | — | — | — |
| **42** | **0x0E** | **1,564** | **Yes** | **6** | **9** | **17** | **71** |
| 54 | 0x10 | — | Yes | — | — | — | — |
